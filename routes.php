...
use Keto_Recipes\Core\Route_Type as Route_Type;
...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'Keto_Recipes\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'Keto_Recipes\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'Keto_Recipes\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'Keto_Recipes\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'Keto_Recipes\App\Models\Admin\Admin_Settings' )
|		->with_view( 'Keto_Recipes\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('Keto_Recipes_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type(ROUTE_TYPE::ADMIN)
	->with_controller('Admin_Settings@register_hook_callbacks') // Resolved by Router to 'Keto_Recipes\App\Controllers\Admin\Admin_Settings'.
	->with_model('Admin_Settings') // Resolved by Router to 'Keto_Recipes\App\Models\Admin\Admin_Settings'.
	->with_view('Admin_Settings'); // Resolved by Router to 'Keto_Recipes\App\Views\Admin\Admin_Settings'.
...
$router
	...
	->with_model('Print_Recipes_Shortcode')
	->with_view('Print_Recipes_Shortcode');
