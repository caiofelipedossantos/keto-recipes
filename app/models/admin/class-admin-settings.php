<?php
namespace Keto_Recipes\App\Models\Admin;

use Keto_Recipes\App\Models\Settings as Settings_Model;
use Keto_Recipes\App\Models\Admin\Base_Model;
...
if ( ! class_exists( __NAMESPACE__ . '\\' . 'Admin_Settings' ) ) {
	 ...
	 * @subpackage Keto_Recipes/models/admin
	 */
