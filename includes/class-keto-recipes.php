<?php
use Keto_Recipes\Includes\i18n;
use Keto_Recipes\Includes\Dependency_Loader;
use Keto_Recipes\Core\Registry\Controller as Controller_Registry;
use Keto_Recipes\Core\Registry\Controller as Model_Registry;
use Keto_Recipes\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'Keto_Recipes' ) ) {
	 ...
	 */
	class Keto_Recipes extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Keto_Recipes    $instance    Instance of this class.
		 */
		 ...
		 * @since    1.0.0
		 */
		const PLUGIN_NAME       = 'Keto Recipes';
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Keto_Recipes::PLUGIN_ID );
